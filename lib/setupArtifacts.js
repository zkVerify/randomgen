 ...
 * 
 * The circuit uses Poseidon(2) hash with 2 inputs (blockHash, userNonce)
 * and RandomPermutate to generate unique shuffled numbers from a contiguous range.
 */
 ...
 * 
 * @param {string} circuitName - Circuit name (required): 'random_3_50', 'random_6_50' etc.
 ...
 * 
 * @param {string} circuitName - Circuit name (required, e.g., "random_15")
