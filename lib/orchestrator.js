 ...
 * - random_15.circom: numOutputs=15, power=15 (production)
...
class RandomCircuitOrchestrator {
   ...
   * @param {string} options.circuitName - Circuit name: 'random' or 'random_3.circom' (default: 'random')
  ...
  constructor(options = {}) {
    ...
    this.circuitName = options.circuitName ?? "random_15";
